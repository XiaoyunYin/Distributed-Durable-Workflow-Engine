...
- **Evidence:** interpreter and transition code, test-only activity fixtures, integration/fault tests, the independent M1 invariant checker work, `docs/CONTRACTS.md`, `docs/BUILD_LOG.md`, and the committed `REVIEW.md` handoff. Review uses `6bc0e2f` as the exact base and target `b41deb6`.
...
- **Evidence:** `internal/invariants/`, `internal/engine/`, `docs/INTERPRETER.md`, and this committed `REVIEW.md` handoff. Correction target is `b41deb6`; review uses `6bc0e2f` as the exact base.
