...
- **Pilot evidence:** `scripts/m7-dur026.ps1 -Pilot` passed 8 pilot configurations at `5ec2f1c`; all 96 pilot workflows reached `SUCCEEDED` with zero pending work. The final study freezes the pilot's two rates, 2 and 8 workflows/second, and its 5,000 deterministic activity work units.
