...
- **Evidence:** `internal/invariants/`, `internal/engine/`, `docs/INTERPRETER.md`, and this committed `REVIEW.md` handoff. Implementation is in `de0c5f2`; review must use `6bc0e2f` as the exact base.
