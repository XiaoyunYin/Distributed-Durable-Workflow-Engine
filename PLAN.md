...
- **Status:** IN_PROGRESS; Claude's round-30 review rejected `7a0ef95` because the scheduler-count, arrival-rate, CPU, and duration evidence was confounded. The prior pilot/final numbers are superseded and must not be used in reports or resume claims.
- **Base commit:** `7a0ef95` (the reviewed but rejected DUR-026 handoff; DUR-036 remains accepted at `6325d1f`).
- **Implementation target:** pending corrected harness and calibration/final evidence commit.
