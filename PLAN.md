...
- **Evidence:** `api/`, `cmd/runtime/`, the DUR-006 integration/API tests, `docs/BUILD_LOG.md`, and the committed `REVIEW.md` handoff at target `d8083d2`. Base is `adf5934`; the exact commands and remaining gaps are recorded in the handoff.
