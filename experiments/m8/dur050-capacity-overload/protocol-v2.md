...
2. **Gate overhead:** at both 0.25 workflows/s and 80% of the highest passing
   ...
   **Pending tooling gate:** do not start this step yet. No committed
   dispatcher/retrieval path currently captures transaction-timing rows from
   both app hosts; implement and review that tooling before step 2.
