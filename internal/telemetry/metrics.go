...
func (m *Metrics) Render() string {
	...
	writeGauge("durable_db_query_seconds_total", "Cumulative database query seconds.", s.QuerySeconds)
	writeGauge("durable_db_lock_wait_seconds_total", "Cumulative database lock-wait seconds.", s.LockWaitSeconds)
